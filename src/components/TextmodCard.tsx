  ...
  return (
    <div className="w-full flex flex-col border border-secondary">
      <div className="flex flex-col p-2">
        <div>
          <Text onHover showHoverable fontSize="2xl" fontType="heading" variant="accent">
            {name}
          </Text>
      ...
      <div className="flex flex-col p-2">
        <div className="flex flex-row justify-between">
          <Text tag="span" fontType="body" showHoverable onHover>{creatorName}</Text>
          <Text tag="span" fontType="body">{createdDate.toDateString()}</Text>
        </div>
        <div className="flex flex-col">
          <div className="flex justify-between flex-row">
            <Text fontSize="base" fontType="body" onHover showHoverable onClick={() => {}}>
